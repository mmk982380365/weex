 ...
 */
- (NSString *)callJSMethod:(NSString *)method args:(NSArray* _Nullable)args;
...
/**
 * Copy object to context's global object's 'key' property.
 */
...
/**
 * Set context name, for legacy JavaScriptCore supporting. It's an empty impl in quickjs bridge.
 */
