...
public class WXBridge implements IWXBridge {
  ...
  private native int nativeExecJSServiceForNative(AssetManager assetManager, String filePath);
  ...
  public native String nativeExecJSOnInstanceByteCode(String instanceId, byte[]script, int type);
  ...
  @Override
  public int execJSServiceForNative(AssetManager assetManager, String filePath) {
//    WXStateRecord.getInstance().recordAction("execJSService","execJSService:");
    return nativeExecJSServiceForNative(assetManager, filePath);
  }
  ...
  public String execJSOnInstanceByteCode(String instanceId, byte[] script, int type) {
    WXStateRecord.getInstance().recordAction(instanceId, "execJSOnInstance:" + type);
    return nativeExecJSOnInstanceByteCode(instanceId, script, type);
  }
  ...
  public void compileQuickJSCallback(String key, byte[] bytecode, int length) {
    WXBridgeManager.getInstance().compileQuickJSCallback(key, bytecode, length);
  }

  public void compileQuickJSBin(String key, String script) {
