...
//        sInstanceJSServiceMap.put(name, service);
        ...
        if (WXEnvironment.getApplication() != null
                && WXEnvironment.getApplication().getApplicationContext() != null
                && WXEnvironment.getApplication().getApplicationContext().getAssets() != null) {
            WXBridgeManager.getInstance()
                    .execJSServiceForNative(WXEnvironment.getApplication().getApplicationContext().getAssets()
                    , "rax.js");
            return true;
        } else {
            Log.e("WXServiceManager", " load rax error but application or aaset is null");
            return false;
        }
