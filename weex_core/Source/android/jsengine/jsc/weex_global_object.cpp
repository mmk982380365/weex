...
static JSValue createWeexConsoleProperty(VM &vm, JSObject *object) {
  ...
  return WeexConsoleObject::create(vm,
                                   global,
                                   WeexConsoleObject::createStructure(vm,
                                                                      global,
...
void WeexGlobalObject::addExtraOptions(std::vector<std::pair<std::string, std::string>> params) {
  if (params.empty()) {
    return;
  }
  VM &vm = this->vm();
  ...
  for (const auto &param : params) {
    String &&type = String::fromUTF8(param.first.c_str());
    String &&value = String::fromUTF8(param.second.c_str());
    addString(vm, WXExtraOption, param.first.c_str(), WTFMove(value));
  }
  addValue(vm, "WXExtraOption", WXExtraOption);
}

void WeexGlobalObject::initWxEnvironment(std::vector<std::pair<std::string, std::string>> params,
                                         bool forAppContext,
                                         bool isSave,
                                         std::vector<std::pair<std::string,
                                                               std::string>> &save_args) {
  VM &vm = this->vm();
  ...
  for (const auto &param : params) {
    ...
    String &&value = String::fromUTF8(param.second.c_str());
    if (isSave) {
      save_args.emplace_back(param.first.c_str(), param.second.c_str());
    }
...
//        doUpdateGlobalSwitchConfig(config);
    ...
    addString(vm, WXEnvironment, type.utf8().data(), WTFMove(value));
  }
...
void WeexGlobalObject::initInstanceContextFunctions() {
  VM &vm = this->vm();
  const HashTableValue JSEventTargetPrototypeTableValues[] = {
      {"nativeLog", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionNativeLogContext), (intptr_t) (5)}},
      {"atob", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionAtob), (intptr_t) (1)}},
      {"btoa", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionBtoa), (intptr_t) (1)}},
      {"callGCanvasLinkNative", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionGCanvasLinkNative), (intptr_t) (3)}},
      {"callT3DLinkNative", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionT3DLinkNative), (intptr_t) (2)}},
      {"setNativeTimeout", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionNativeSetTimeout), (intptr_t) (2)}},
      {"setNativeInterval", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionNativeSetInterval), (intptr_t) (2)}},
      {"clearNativeTimeout", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionNativeClearTimeout), (intptr_t) (1)}},
      {"clearNativeInterval", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionNativeClearInterval), (intptr_t) (1)}},
      {"console", DontEnum | PropertyCallback, NoIntrinsic,
       {(intptr_t) static_cast<LazyPropertyCallback>(createWeexConsoleProperty), (intptr_t) (0)}},
      {"__updateComponentData", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionUpdateComponentData), (intptr_t) (3)}},
  };
  reifyStaticProperties(vm, JSEventTargetPrototypeTableValues, *this);
}

void WeexGlobalObject::initGlobalContextFunctions() {
  VM &vm = this->vm();
  const HashTableValue JSEventTargetPrototypeTableValues[] = {
      {"callNative", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallNative), (intptr_t) (3)}},
      {"callNativeModule", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallNativeModule), (intptr_t) (5)}},
      {"callNativeComponent", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallNativeComponent), (intptr_t) (5)}},
      {"callAddElement", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallAddElement), (intptr_t) (5)}},
      {"setTimeoutNative", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionSetTimeoutNative), (intptr_t) (2)}},
      {"nativeLog", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionNativeLog), (intptr_t) (5)}},
      {"notifyTrimMemory", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionNotifyTrimMemory), (intptr_t) (0)}},
      {"markupState", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionMarkupState), (intptr_t) (0)}},
      {"atob", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionAtob), (intptr_t) (1)}},
      {"btoa", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionBtoa), (intptr_t) (1)}},
      {"callCreateBody", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallCreateBody), (intptr_t) (3)}},
      {"callUpdateFinish", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallUpdateFinish), (intptr_t) (3)}},
      {"callCreateFinish", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallCreateFinish), (intptr_t) (3)}},
      {"callRefreshFinish", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallRefreshFinish), (intptr_t) (3)}},
      {"callUpdateAttrs", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallUpdateAttrs), (intptr_t) (4)}},
      {"callUpdateStyle", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallUpdateStyle), (intptr_t) (4)}},
      {"callRemoveElement", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallRemoveElement), (intptr_t) (3)}},
      {"callMoveElement", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallMoveElement), (intptr_t) (5)}},
      {"callAddEvent", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallAddEvent), (intptr_t) (4)}},
      {"callRemoveEvent", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionCallRemoveEvent), (intptr_t) (4)}},
      {"callGCanvasLinkNative", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionGCanvasLinkNative), (intptr_t) (3)}},
      {"setIntervalWeex", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionSetIntervalWeex), (intptr_t) (3)}},
      {"clearIntervalWeex", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionClearIntervalWeex), (intptr_t) (1)}},
      {"callT3DLinkNative", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionT3DLinkNative), (intptr_t) (2)}},
      {"__updateComponentData", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionUpdateComponentData), (intptr_t) (3)}},
...
void WeexGlobalObject::initAppContextFunctions() {
  VM &vm = this->vm();
  const HashTableValue JSEventTargetPrototypeTableValues[] = {
      {"nativeLog", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionNativeLogContext), (intptr_t) (5)}},
      {"__dispatch_message__", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionDisPatchMeaage), (intptr_t) (3)}},
      {"__dispatch_message_sync__", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionDispatchMessageSync), (intptr_t) (3)}},
      {"postMessage", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionPostMessage), (intptr_t) (1)}},
      {"setNativeTimeout", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionNativeSetTimeout), (intptr_t) (2)}},
      {"setNativeInterval", JSC::Function, NoIntrinsic,
       {(intptr_t) static_cast<NativeFunction>(functionNativeSetInterval), (intptr_t) (2)}},
...
void WeexGlobalObject::addTimer(uint32_t function_id, JSC::Strong<JSC::Unknown> &&function) {
  ...
  function_maps_.insert(std::pair<uint32_t, JSC::Strong<JSC::Unknown>>(function_id,
                                                                       WTFMove(function)));
}
...
void WeexGlobalObject::updateInitFrameworkParams(const std::string &key,
  ...
  for (auto param : save_args) {
    if (param.first == key && param.second != value) {
      param.second = value;
    }
  }
}
void WeexGlobalObject::destroyTimer() {
  function_maps_.clear();
}
...
JSFUNCTION functionClearIntervalWeex(ExecState *state) {
  ...
  globalObject->js_bridge()->core_side()->ClearInterval(id_str.utf8().data(),
                                                        callback_str.utf8().data());
...
JSFUNCTION functionT3DLinkNative(ExecState *state) {
  ...
  auto result =
      globalObject->js_bridge()->core_side()->CallT3DLinkNative(type, arg_str.utf8().data());
  return JSValue::encode(String2JSValue(state, result));
}
...
//    std::string msg = instanceId.getValue();
//    msg += " Module :";
//    msg += moduleChar.getValue();
//    msg += " method:";
//    msg += methodChar.getValue();
//    msg += " callNativeModule arguments";
//
//    __android_log_print(ANDROID_LOG_ERROR,
//                        "DYYDEBUG","callNative Module %d %d",arguments.wson->position, arguments.wson->length);
//
//    printWson(msg, arguments.wson);
  ...
  JSValue ret;
  switch (result->type) {
    case ParamsType::DOUBLE:ret = jsNumber(result->value.doubleValue);
      break;
    case ParamsType::STRING:
      ret = jString2JSValue(state,
    ...
    case ParamsType::BYTEARRAY: {
      ret = wson::toJSValue(state,
                            (void *) result->value.byteArray->content,
                            result->value.byteArray->length);
      free(result->value.byteArray);
    }
      break;
    default:ret = jsUndefined();
  }
...
JSFUNCTION functionCallCreateBody(ExecState *state) {
  ...
  globalObject->js_bridge()->core_side()->CreateBody(pageId.getValue(),
                                                     domStr.getValue(),
                                                     domStr.getLength());
  return JSValue::encode(jsNumber(0));
}
...
JSFUNCTION functionPostMessage(ExecState *state) {
  ...
  globalObject->js_bridge()->core_side()->PostMessage(id.utf8().data(),
                                                      data.c_str(),
                                                      dataChar.getLength());
  return JSValue::encode(jsNumber(0));
}
...
JSFUNCTION functionDisPatchMeaage(ExecState *state) {
  ...
  String id(globalObject->id.c_str());
  std::string data(dataChar.getValue());
  globalObject->js_bridge()->core_side()->DispatchMessage(clientIdChar.getValue(),
                                                          data.c_str(),
                                                          dataChar.getLength(),
                                                          callBackChar.getValue(),
                                                          id.utf8().data());
...
static void setNativeTimeout(uint32_t kId,
                             uint64_t timeout,
                             WeexGlobalObject *globalObject,
                             bool repeat) {
  weex::base::MessageLoop::GetCurrent()->PostDelayedTask(
      [functionId = kId, time = timeout, re = repeat, jsContext = globalObject] {
        VM &vm = jsContext->vm();
        JSLockHolder *locker = new JSLockHolder(&vm);
        const JSValue &function = jsContext->getTimerFunction(functionId);
        ...
        ArgList a;
        JSValue ret = call(jsContext->globalExec(),
                           function,
                           callType,
                           callData,
                           jsContext,
        ...
        if (re) {
          const JSValue &function1 = jsContext->getTimerFunction(functionId);
          if (function1.isUndefined()) {
            return;
          }
          setNativeTimeout(functionId, time, jsContext, true);
        } else {
          jsContext->removeTimer(functionId);
        }
...
JSFUNCTION functionNativeSetTimeout(ExecState *state) {
  ...
  auto timeout = static_cast<uint64_t>(jsValue.asInt32());
  uint32_t kId = globalObject->genFunctionID();
  globalObject->addTimer(kId, JSC::Strong<JSC::Unknown>{vm, JSC::asObject(value)});
  setNativeTimeout(kId, timeout, globalObject, false);
  return JSValue::encode(jsNumber(kId));
}
...
JSFUNCTION functionNativeSetInterval(ExecState *state) {
  ...
  uint32_t kId = globalObject->genFunctionID();
  globalObject->addTimer(kId, JSC::Strong<JSC::Unknown>{vm, JSC::asObject(value)});
  setNativeTimeout(kId, timeout, globalObject, true);
  return JSValue::encode(jsNumber(kId));
}
...
JSFUNCTION functionNativeClearTimeout(ExecState *state) {
  WeexGlobalObject *globalObject = static_cast<WeexGlobalObject *>(state->lexicalGlobalObject());
  const JSValue &value = state->argument(0);
  globalObject->removeTimer(value.asInt32());
...
JSFUNCTION functionUpdateComponentData(ExecState *state) {
  ...
  if (json_data == nullptr) {
    globalObject->js_bridge()->core_side()->ReportException(page_id.get(),
                                                            "UpdateComponentData",
                                                            "parse json failed");
    return JSValue::encode(jsUndefined());
  }
  globalObject->js_bridge()->core_side()->UpdateComponentData(page_id.get(),
                                                              cid.get(),
                                                              json_data.get());
  return JSValue::encode(jsUndefined());
}
