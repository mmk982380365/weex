...
static jint ExecJSServiceForNative(JNIEnv *env, jobject jcaller, jobject assetManager,
                          jstring filePath);
...
static intptr_t g_WXBridge_compileQuickJSCallback = 0;
static void Java_WXBridge_compileQuickJSCallback(JNIEnv *env, jobject obj, jstring
key, jbyteArray bytecode, int length) {
  jmethodID method_id =
      base::android::GetMethod(
          env, WXBridge_clazz(env),
          base::android::INSTANCE_METHOD,
          "compileQuickJSCallback",
          ...
          ")"
          "V",
          &g_WXBridge_compileQuickJSCallback);
  env->CallVoidMethod(obj,
                      method_id, key, bytecode, length);
...
static const JNINativeMethod kMethodsWXBridge[] = {
    ...
    {"nativeExecJSServiceForNative",
     "("
     "Landroid/content/res/AssetManager;"
     "Ljava/lang/String;"
     ")"
     "I", reinterpret_cast<void *>(ExecJSServiceForNative)},
    ...
    {"nativeCompileQuickJSBin",
     "("
     "Ljava/lang/String;"
     "Ljava/lang/String;"
     ")"
     "V", reinterpret_cast<void *>(CompileQuickJSBin)},
    ...
    {"nativeExecJSOnInstanceByteCode",
     "("
     "Ljava/lang/String;"
     "[B"
     "I"
     ")"
     "Ljava/lang/String;", reinterpret_cast<void *>(ExecJSOnInstanceByteCode)},
